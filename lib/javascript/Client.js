...
function kb_variation_importer(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.import_snp_data = function (import_snp_params, _callback, _errorCallback) {
        if (typeof import_snp_params === 'function')
            throw 'Argument import_snp_params can not be a function';
        ...
        return json_call_ajax(_url, "kb_variation_importer.import_snp_data",
            [import_snp_params], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_variation_importer.status",
