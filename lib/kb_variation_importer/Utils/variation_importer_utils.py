...
class variation_importer_utils:
        ...
        try:
            ...
            with open(template_dir, 'r') as html, open(variation_results['validation_output_filepath'], 'r') as validation:
                ...
                if variation_results.get('invalid_contigs'):
                    validation_content += '<h4>The following Contigs were not found in Genome {}.  The possible contigs have been written to the file valid_contigs.txt.  Please see the associated links to download.</h4>'.format(
    ...
    def _generate_variation_stats(self, cmd_line_args, variation_filepath):
        ...
        zoom_command = '''awk '{{ if ($9 < 0.00001) print $0 }}' {} > {}'''.format(hwe_filepath, zoom_filepath)
